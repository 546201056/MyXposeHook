...
public class HookDemo implements IXposedHookLoadPackage {
    ...
    public void handleLoadPackage(XC_LoadPackage.LoadPackageParam loadPackageParam) throws Throwable {
        ...
        if (loadPackageParam.packageName.equals("com.example.administrator.xpose_hook6")) {
            XposedBridge.log("11111" );
            Class clasz = loadPackageParam.classLoader.loadClass("com.example.administrator.xpose_hook6.MainActivity");
